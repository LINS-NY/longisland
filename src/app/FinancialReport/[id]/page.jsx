                ...
                >
                  {isHeaderMergeRow ? (
                    ...
                    values.map((cell, i) => (
                      <td
  key={i}
  className={`border border-gray-300 px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-800 ${
    isTableHeader ? 'text-center font-bold text-blue-900 dark:text-blue-200 bg-blue-50 dark:bg-blue-900 uppercase' :
