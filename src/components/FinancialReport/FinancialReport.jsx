   ...
   content.map((val,index) => {
        ...
        contTable.push(
            <tr class="border-b border-neutral-00 bg-black/[0.02] dark:border-white/10 hover:bg-cyan-200 " key={index}>
                <td class=" text-black lg:whitespace-nowrap lg:px-6 px-1 lg:py-4 sm:font-medium" key={index}>{val[0]}</td>
                <td class="lg:whitespace-nowrap text-black lg:px-6  lg:py-4 sm:font-medium" key={index}>{val[1]}</td>
                <td class="lg:whitespace-nowrap text-black lg:px-6  lg:py-4 sm:font-medium" key={index}>{val[2]}</td>
                <td class="lg:whitespace-nowrap text-black lg:px-6  lg:py-4 sm:font-medium" key={index}>{val[3]}</td>
                <td class="lg:whitespace-nowrap text-black lg:px-6  lg:py-4 sm:font-medium" key={index}>{val[4]}</td>
            </tr>
        )
    })  
    return(
