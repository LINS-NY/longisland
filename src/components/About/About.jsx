        ...
        <div class="  bg-white flex">
            <div class="max-w-screen-xl flex flex-col mx-auto p-4">
                <div class="flex flex-col justify-center items-center ">
                    ...
                    <article class="indent-4 text-pretty text-justify font-serif font-medium">
                    <p class="p-2 md:px-5">The Long Island Nepalese Society in New York (LINSNY) is a non-profit organization based in East Meadow, NY, that serves the Nepalese community in Long Island. Established in 2012, the organization promotes cultural, educational, and social activities for Nepalese immigrants. LINSNY regularly organizes events such as Nepali language classes, cultural festivals like Holi and Nepali New Year celebrations, and community service initiatives. It aims to preserve Nepalese heritage while fostering a sense of unity and support within the diaspora.</p>
                    <p class="p-2 md:px-5">The organization is registered as a 501(c)(3) nonprofit, meaning it is eligible for tax-deductible donations, and it focuses on community improvement and capacity-building activities.</p>
                    <p class="p-2 md:px-5">For more information on their ongoing activities, you can visit their community social media pages or other platforms where they frequently share updates on their programs.</p>
                    </article>
                </div>
                <Member/>
            </div>
