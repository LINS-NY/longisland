...
export default async function IndividualItem({items}){
    ...
    return(
      <article class="p-4 flex flex-col justify-between gap-2 border rounded-lg shadow-md bg-white dark:bg-gray-700 dark:border-gray-400/40 text-align: left;">
        <Link  href={`/Resource/${encodeURIComponent(items.id)}`}>
          ...
          <div class="p-4 text-sm md:text-lg font-semibold text-gray-500 dark:text-gray-400">
            {source}
          </div>
