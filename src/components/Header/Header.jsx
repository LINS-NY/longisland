...
<<<<<<< HEAD
          <div class="hidden sm:flex flex-row justify-between p-4">
            <Image
              ...
              alt="Lins logo"
            />
            <span class="self-center text-lg font-extrabold whitespace-nowrap  text-blue-900 dark:text-white">
              Long Island Nepalese Society, New York
              <p>लङ्ग आईल्यान्ड नेपाली समाज, न्युयोर्क</p>
            </span>
          </div>
          ...
          <div class="md:hidden">
            <ul class="text-sm sm:font-bold sm:text-lg flex flex-row  mt-1 border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse    dark:bg-gray-800  dark:border-gray-700">
              <li>
                <Link
                  href="/"
                  class="block p-2 sm:p-4  text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white  dark:hover:bg-gray-700 dark:hover:text-white  "
                  aria-current="page"
                >
                  Home
                </Link>
...
=======
            ...
            <div class="md:hidden">
                <ul class="text-sm sm:font-bold sm:text-lg flex flex-row  mt-1 border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse    dark:bg-gray-800  dark:border-gray-700">
                    ...
                    <li>
                        <Link href="/Forums" class="block p-2 sm:p-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white  dark:hover:bg-gray-700 dark:hover:text-white ">Forum</Link>
                    </li>
                    <li>
