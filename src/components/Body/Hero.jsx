...
const Hero = () => {
  return (
    <div>
      <section
        class="sm:hidden relative container rounded-xl mx-auto  my-5  w-5/6  h-96 shadow-sm dark:bg-gray-900 bg-cover bg-no-repeat bg-center"
            ...
            <div class="flex flex-col text-center mx-5 justify-center item-center">
              ...
              <div class="flex  flex-wrap text-sm font-light item-center justify-center">
                <Link href="/FinancialReport">
                  <button
                    class="bg-cyan-500 dark:bg-slate-800 shadow-gray-700  dark:shadow-slate-950   
                ...
                <Link href="/About">
                  <button
                    class="bg-cyan-500 dark:bg-slate-800 shadow-gray-700  
                ...
                <Link href="/News">
                  <button
                    class="bg-cyan-500 dark:bg-slate-800 shadow-gray-700 dark:text-white 
                            dark:shadow-slate-950   shadow-lg rounded-lg p-2 text-white m-2 drop-shadow-2xl"
                  >
                    LINS News
                  </button>
                </Link>
        ...
        <div class="relative flex justify-between m-2 sm:w-5/6 h-full mx-auto">
          <div class="flex justify-center ">
            <div class="flex flex-col sm:mx-15 mx-4 justify-center item-center">
              ...
              <p
                class="sm:max-w-2xl mb-4 text-md md:text-2xl sm:font-extrabold tracking-tight 
          ...
          <div class=" hidden sm:flex sm:mx-5 justify-center">
            <div class="flex flex-col justify-center">
              <Image src="/LINS.png" width={200} height={200} alt="Lins logo" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 p-8 bg-gray-100">
        {/* President's Message */}
        <Link href="/PresidentialMessages">
          <div class="relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
            <div class="grid px-8 place-items-center py-6">
              <Image
                src="/Members/RajanGouli.png"
                width={200}
                height={200}
                alt="RajanGauli"
                class="rounded-full border-4 border-blue-500 transition-transform transform hover:scale-110"
              />
            </div>
            <div class="text-center px-6 pb-6">
              <h1 class="text-3xl font-extrabold text-blue-900 mb-4 tracking-tight">
                President's Message
              </h1>
