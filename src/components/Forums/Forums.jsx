    ...
    <div class="">
      <div
        className={`flex flex-col item-center justify-center ${
          openModel ? "blur-2xl" : "display"
        } bg-white/30`}
      >
        <div class="flex flex-row justify-between">
          <h1 class="p-2 font-bold font-serif tracking-wide md:text-3xl text-xl text-blue-400 ">
            Forum
          </h1>
...
const NewCreate = ({ createTopic, setInput, input }) => {
  return (
    <div
      ...
      tabindex="-1"
      aria-hidden="true"
      class=" overflow-y-auto overflow-x-hidden absolute inset-0 h-screen flex justify-center items-center w-full md:inset-0  max-h-full"
    >
