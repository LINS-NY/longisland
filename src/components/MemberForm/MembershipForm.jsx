...
export default function MembershipForm() {
  ...
  <p className="text-sm leading-7 text-justify mt-4">
    ...
    members of the organization. Approved members may enjoy the
    benefits, programs, services, and opportunities offered by LINSNY
    in accordance with organizational rules and policies.
  </p>
</div>
